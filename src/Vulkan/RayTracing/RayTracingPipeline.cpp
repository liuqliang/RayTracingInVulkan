	...
	swapChain_(swapChain)
{
	...
	switch (shaderType) {
		...
		case 6:
			...
			break;
		case 7:
			printf("RTV: Using anyhit terminate validation shader.\n");
			rayGenShader = new ShaderModule(device, "../assets/shaders/TraceTree.rgen.spv");
			closestHitShader = new ShaderModule(device, "../assets/shaders/RayTracing.rchit.spv");
		...
		case 22:
			...
			break;
		case 23:
			printf("RTV: Using continuation register-pressure validation.\n");
		...
		case 24:
			...
			break;
		case 25:
			printf("RTV: Using continuation save-batch pressure validation.\n");
			rayGenShader = new ShaderModule(device, "../assets/shaders/TraceSaveBatchPressure.rgen.spv");
			closestHitShader = new ShaderModule(device, "../assets/shaders/TracePressure.rchit.spv");
			break;
		default:
